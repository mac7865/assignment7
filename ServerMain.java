...
public class ServerMain extends Observable { 
	...
	public void setUpNetworking() throws Exception {
		...
		while (true) { 
			...
			ServerGui.appendToConsole("got a connection");
		}
	} 
				...
				while ((command = reader.readLine()) != null) { 
					...
					if(commandSplit[0].equals("Register")) {
						if(userDatabase.containsKey(commandSplit[1])) {
							...
							ServerGui.appendToConsole("new registration username: " + commandSplit[1] + " password: " + commandSplit[2] );
						...
						ServerGui.appendToConsole("Login attempt username: " + commandSplit[1] + " password: " + commandSplit[2] );
						...
						ServerGui.appendToConsole(command);
						...
						while(!recp.equals("Message") && recipientsExist) {
							if(userDatabase.containsKey(recp)) {
								...
								ServerGui.appendToConsole("bad recp " + recp);
							}
						}
						if(recipientsExist) {
							setChanged(); 
